...
namespace CANbuilder.Test
{
    public class ObjectDictionaryIndexTest
    {
        ...
        {
            // ACT
            var result = new ObjectDictionaryIndex(0x0102, 3);
        ...
        {
            // ACT
            var result = new ObjectDictionaryIndex(new byte[] { 0x01, 0x02, 3 });
        ...
        {
            // ARRANGE
            var index = new ObjectDictionaryIndex(0x0102, 3);

            // ACT
            var result = new ObjectDictionaryIndex(0x0102, 3).SetSubIndex(4);
        ...
        public void Change_index()
        {
            ...
            // ACT
            var result = new ObjectDictionaryIndex(0x0102, 3).SetIndex(0x0203);
